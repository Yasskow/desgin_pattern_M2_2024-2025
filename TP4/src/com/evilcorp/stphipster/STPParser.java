...
public class STPParser {
	...
	/**
	 * Convert a text command to the corresponding object in the the {@link com.evilcorp.stp.STPCommand}.
	 * If the format of cmd is invalid, returns Optional.empty()
	 * @param cmd
	 *         the line to be parsed. Must be non-null.
	 * @return the corresponding {@link com.evilcorp.stp.STPCommand} wrapped in a {@link Optional}
	 */
